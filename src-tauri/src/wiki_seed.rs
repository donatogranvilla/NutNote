...
pub fn seed_wiki_guides(conn: &Connection) -> Result<(), rusqlite::Error> {
    ...
    let ch2_blocks = vec![
        ...
        ("blk-c2-12f", "bulletList", bullet("Diagrammi & Schemi di Flusso (Mermaid.js): genera flowchart, sequenze API e roadmap partendo da semplice testo con export vettoriale SVG.")),
        ("blk-c2-12g", "bulletList", bullet("Tabelle Calcolate con Formule: mini foglio stile spreadsheet per preventivi veloci con somme automatiche ed export CSV.")),
        ("blk-c2-12h", "bulletList", bullet("Vista Database Incorporata: mini-tabella live che filtra pagine e task da tutto il workspace direttamente nel corpo del testo.")),
        ...
        ("blk-c2-30", "heading", h2("2.6 Approfondimento sui 7 Blocchi di Utilità Operativa")),
        ("blk-c2-31", "paragraph", p("NutNote mette a disposizione 7 blocchi interattivi pensati specificamente per l'operatività quotidiana di aziende e studi tecnici:")),
        ("blk-c2-32", "numbered", numbered("1. Blocco Cartella Locale / Server: collega percorsi fisici o di rete (es. 'C:\\Progetti\\ClienteX' o '\\\\Server\\Condivisa') con visualizzazione file e apertura diretta in Windows.")),
        ("blk-c2-33", "numbered", numbered("2. Blocco Evento & Calendario (.ics): calcola countdown live e genera file standard .ics per Outlook e Google Calendar.")),
        ("blk-c2-34", "numbered", numbered("3. Blocco Segnalibro Web: card ricche per portali clienti e documentazione con favicon automatica.")),
        ("blk-c2-35", "numbered", numbered("4. Blocco Cassaforte Credenziali: archivio sicuro per password e secret mascherati anti shoulder-surfing con copia a 1 clic.")),
        ("blk-c2-36", "numbered", numbered("5. Blocco Diagrammi Mermaid (/mermaid): genera flowchart vettoriali, diagrammi di sequenza e architetture partendo da codice testuale, con esportazione file .svg.")),
        ("blk-c2-37", "numbered", numbered("6. Blocco Tabella Calcolata (/calc): foglio rapido con colonne numeriche/valuta, formule e somme automatiche per preventivi, esportabile in .csv per Excel.")),
        ("blk-c2-38", "numbered", numbered("7. Blocco Vista Database (/query): incorpora nel corpo della nota una tabella dinamica che filtra in tempo reale le pagine e i task del workspace.")),
    ];
    ...
    let ch7_blocks = vec![
        ...
        ("blk-c7-7b", "heading", h2("7.2 Importazione Documenti da File Markdown (.md)")),
        ("blk-c7-7c", "paragraph", p("Oltre all'esportazione, NutNote permette di importare al volo documenti esterni in formato Markdown (.md o .txt):")),
        ("blk-c7-7d", "bulletList", bullet("Apri il menu '•••' nella testata della pagina e seleziona 'Importa File Markdown (.md)'.")),
        ("blk-c7-7e", "bulletList", bullet("Seleziona il file dal tuo computer: NutNote converte automaticamente titoli, checkbox todo, elenchi, citazioni, tabelle, callout e blocchi di codice in blocchi interattivi nativi.")),
        ("blk-c7-7f", "bulletList", bullet("Se la pagina corrente era priva di titolo, NutNote adotta automaticamente il titolo H1 del file importato.")),
        ("blk-c7-8", "heading", h2("7.3 Esportazione Dati Tabellari (Excel & CSV)")),
